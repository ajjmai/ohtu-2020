...
public class Stepdefs {
    ...
    public void aValidUsernameAndATooShortPasswordAndMatchingPasswordConfirmationAreEntered(String username,
            String password) {
        createUser(username, password, password);
    }

    @When("a valid username {string} and a only-letters password {string} and matching password confirmation are entered")
    public void aValidUsernameAndAOnlyLettersPasswordAndMatchingPasswordConfirmationAreEntered(String username,
            String password) {
        createUser(username, password, password);
    }
